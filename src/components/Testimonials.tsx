  ...
  const testimonials = [
    {
      ...
      text: "Lum Tech Building Solutions did an incredible job on our new home. Professional from start to finish! The quality of workmanship exceeded our expectations and they completed the project on time.",
      rating: 5,
          ...
          <div className="mt-16 bg-primary text-white p-8 rounded-lg">
            <div className="text-center">
              ...
              <p className="font-open-sans text-gray-200 mb-6 max-w-2xl mx-auto">
                Experience the Lum Tech Building Solutions difference. Quality workmanship, professional service, 
